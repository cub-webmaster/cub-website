...
const links: Record<string, Link> = {
    ...
    donate: { url:'https://www.philanthropy.cam.ac.uk/give-to-cambridge/cambridge-university-bowmen-club',
		label: 'Donate',},
    signup: { url: "https://www.eventbrite.co.uk/e/cub-training-sessions-tickets-1981018056334", label: "Sessions Signup"},
    calendar: { url: "https://calendar.google.com/calendar/u/4?cid=ZWRyMGxoZ3Q5cW1sYjFqdmU5MHI4c2lvcDhAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ", label: "CUB Calendar"},
